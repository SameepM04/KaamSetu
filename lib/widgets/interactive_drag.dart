...
class _InteractiveDragState extends State<InteractiveDrag>
      ...
      builder: (context, constraints) {
        ...
        return GestureDetector(
          onHorizontalDragUpdate: (details) {
            if (_completed) return;
            _controller.value = (_controller.value + details.delta.dx / travel)
                .clamp(0.0, 1.0)
                .toDouble();
          },
          onHorizontalDragEnd: (_) {
            if (_controller.value > .82) {
              ...
              _controller.animateTo(widget.centerThumb ? .5 : 0,
                    ...
                    child: Row(
                      children: [
                        ...
                        const Icon(Icons.arrow_forward_rounded,
                            color: AppColors.electricBlue, size: 31),
                      ],
                    ),
                  ),
                ),
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        gradient: const LinearGradient(
                            colors: [Color(0xFF5187FF), AppColors.blue]),
                        boxShadow: const [
                          BoxShadow(
                              color: Color(0x66336AF0),
                              blurRadius: 19,
                              offset: Offset(0, 7))
                        ],
                      ),
