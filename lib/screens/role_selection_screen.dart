                ...
                return SingleChildScrollView(
                  ...
                  child: ConstrainedBox(
                    constraints: BoxConstraints(
                        minHeight: constraints.maxHeight - (compact ? 20 : 38)),
                    child: Column(
                          ...
                          child: ScaleTransition(
                            ...
                            child: AnimatedBuilder(
                              ...
                              builder: (context, child) {
                                final breatheScale =
                                    1 + (_breathe.value * .018);
                                return Transform.scale(
                                    scale: breatheScale, child: child);
                              },
                              child: const Center(
                                  child: KaamSetuBrand(compact: true)),
                            ),
                          ),
                        ),
                              ...
                              child: Row(
                                ...
                                children: [
                                  Expanded(
                                    child: RoleCard(
                                      imageAsset:
                                          'assets/role_selection/worker.png',
                                      title: 'I am a Worker',
                                      subtitle:
                                          'Find daily work near you and grow your skills.',
                                  ...
                                  Expanded(
                                    child: RoleCard(
                                      imageAsset:
                                          'assets/role_selection/house.png',
                                      title: 'I am a Household',
                                      subtitle:
                                          'Hire trusted local workers for your daily needs.',
                          ...
                          child: AnimatedBuilder(
                            ...
                            builder: (context, child) {
                              ...
                              return Transform.translate(
                                  offset: Offset(0, lift), child: child);
                            },
...
class _BackButtonState extends State<_BackButton>
  ...
  Widget build(BuildContext context) {
    return AnimatedBuilder(
      ...
      builder: (context, child) =>
          Transform.scale(scale: 1 - _controller.value * .12, child: child),
      child: Material(
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border:
            Border.all(color: Colors.white.withValues(alpha: .9), width: 1.2),
        boxShadow: const [
          BoxShadow(
              color: Color(0x144775B4), blurRadius: 18, offset: Offset(0, 8))
        ],
      ),
      child: Row(
