...
void main() {
  ...
  Widget appFor(Widget screen) => MaterialApp(theme: AppTheme.light, home: screen);
  ...
  testWidgets('onboarding one visual baseline', (tester) async {
    ...
    await expectLater(find.byType(OnboardingOne), matchesGoldenFile('goldens/onboarding_one.png'));
  });
  ...
  testWidgets('onboarding two visual baseline', (tester) async {
    ...
    await expectLater(find.byType(OnboardingTwo), matchesGoldenFile('goldens/onboarding_two.png'));
  });
  ...
  testWidgets('onboarding three visual baseline', (tester) async {
    ...
    await expectLater(find.byType(OnboardingThree), matchesGoldenFile('goldens/onboarding_three.png'));
  });
}
